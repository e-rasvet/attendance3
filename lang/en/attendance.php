...
$string['usekeyword'] = 'Use keyword input system';
$string['keyword'] = 'Keyword';
$string['minuteslate'] = 'Minutes until late';
$string['keyw_help'] = 'Set an initial keyword. You can update the keyword before each class.';
$string['late_help'] = '"Tick the box and set a time up to 60 minutes" for determining who registers late.';
$string['offcampus'] = 'Off-campus';